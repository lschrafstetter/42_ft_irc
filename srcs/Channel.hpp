...
class Channel {
  public:
    ...
    const std::set<std::string, irc_stringmapcomparator<std::string> >& get_operators(void) const;
    const std::set<std::string, irc_stringmapcomparator<std::string> >& get_banned_users(void) const;
    const std::set<std::string, irc_stringmapcomparator<std::string> >& get_speakers(void) const;
    const std::set<std::string, irc_stringmapcomparator<std::string> >& get_invited_users(void) const;
